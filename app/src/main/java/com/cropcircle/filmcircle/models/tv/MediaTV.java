...
public class MediaTV {
    ...
    public MediaTV(String backdropPath, List<CreatedBy> createdBy, List<Integer> episodeRunTime,
                   ...
                   Object nextEpisodeToAir, List<Network> networks, Integer numberOfEpisodes,
                   Integer numberOfSeasons, List<String> originCountry, String originalLanguage,
                   String originalName, String overview, Double popularity,
                   String posterPath, List<ProductionCompany> productionCompanies,
                   List<Season> seasons, String status, String tagline, String type,
